       ...
       PROCEDURE DIVISION.
           ...
           IF O-ANDAMENTO NOT EQUAL 2
               MOVE "NAO E POSSIVEL DELETAR" TO MSG
               DISPLAY TELA1-MENSAGEM
               ACCEPT PRESS-ENTER
               CALL "PGM2"
           ELSE
               MOVE "DIGITE D PARA DELETAR OUTRO PARA CANCELAR" TO MSG
               DISPLAY TELA1-MENSAGEM
               ACCEPT PRESS-ENTER
           END-IF
           ...
           IF CONFIRM = "D"
               OPEN I-O ARQ-OCORR
                   ...
                   END-DELETE
               CLOSE ARQ-OCORR
               MOVE "OCORRENCIA DELETADA" TO MSG
               DISPLAY TELA1-MENSAGEM
               ACCEPT PRESS-ENTER
           ELSE
               MOVE "OPERACAO CANCELADA" TO MSG
               DISPLAY TELA1-MENSAGEM
               ACCEPT PRESS-ENTER
           END-IF
