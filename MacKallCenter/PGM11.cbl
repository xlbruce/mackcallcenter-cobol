      *INSERIR CLIENTE
       ...
       01  TELA.
           ...
           VALUE "DATA INCLUSAO..: [ / /   ]".
           05 S-DT-INCLUSAO.
               10 S-DT-DIA LINE 21 COLUMN 22 PIC 99 TO DATA-INCLUSAO.
               10 S-DT-MES LINE 21 COLUMN 24 PIC 99 TO DATA-INCLUSAO.
               10 S-DT-ANO LINE 21 COLUMN 26 PIC 9999 TO DATA-INCLUSAO.
            
           05 LINE 22 COLUMN 04
           VALUE "DATA ULT ALTERACAO [  /  /    ]".
           05 S-UL-INCLUSAO.
               10 S-UL-DIA LINE 22 COLUMN 24 PIC 99 TO 
               DATA-ULTIMA-ALTERACAO.
               
               10 S-UL-MES LINE 22 COLUMN 26 PIC 99 TO 
               DATA-ULTIMA-ALTERACAO.
               10 S-UL-ANO LINE 22 COLUMN 28 PIC 9999 TO 
               DATA-ULTIMA-ALTERACAO.
       ...
       INICIO.
           ...
           ACCEPT S-PONTOS
           ACCEPT S-VENCIMENTO
           ACCEPT S-DT-INCLUSAO
           ACCEPT S-UL-INCLUSAO
            OPEN I-O ARQ-CLIENTES
               READ ARQ-CLIENTES
               IF ST-CLIENTE = "23"
                   WRITE REG-CLIENTE
                   DISPLAY S-SUCESSO
                   display "Cadastrado com sucesso" at 2515
               ELSE
